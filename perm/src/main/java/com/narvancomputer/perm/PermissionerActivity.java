...
public class PermissionerActivity extends AppCompatActivity {
    ...
    private void permissionGranted() {
        BusProvider.getInstance().post(new PermissionerEvent(true, null));
        finish();
        overridePendingTransition(0, 0);
    }

    private void permissionDenied(ArrayList<String> deniedpermissions) {
        BusProvider.getInstance().post(new PermissionerEvent(false, deniedpermissions));
        finish();
        overridePendingTransition(0, 0);
    }
